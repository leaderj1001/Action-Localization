...
__C.TRAIN.SNAPSHOT_PREFIX = 'faster_rcnn_action'
...
# Experimental: treat the (K+1) units in the cls_score layer as linear predictors (trained, eg, with one-vs-rest SVMs).
__C.TEST.SVM = False
